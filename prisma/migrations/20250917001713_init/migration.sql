...
CREATE TABLE "public"."protuario" (
    ...
    CONSTRAINT "protuario_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "public"."protuario" ADD CONSTRAINT "protuario_paciente_id_fkey" FOREIGN KEY ("paciente_id") REFERENCES "public"."paciente"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."protuario" ADD CONSTRAINT "protuario_medico_responsavel_id_fkey" FOREIGN KEY ("medico_responsavel_id") REFERENCES "public"."usuario"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
